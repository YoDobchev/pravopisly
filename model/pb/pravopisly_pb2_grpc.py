...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in pravopisly_pb2_grpc.py depends on'
...
def add_PravopislyCommsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendText': grpc.unary_unary_rpc_method_handler(
                    servicer.SendText,
                    request_deserializer=pravopisly__pb2.SendToModel.FromString,
                    response_serializer=pravopisly__pb2.ModelReply.SerializeToString,
            ),
    }
